...
import { Edit3, Search, Save, FolderPlus, PlayCircle, BookOpen, Library } from "lucide-react";
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div>
        ...
        <p className="text-lg text-muted-foreground max-w-3xl">
          Access extracted records for active gameplay, browse the library shelves to view source material alongside OCR results, and organize your knowledge for quick reference.
        </p>
      </div>

      <Tabs defaultValue="active-play" className="w-full">
        <TabsList className="bg-card/50 border border-border/50 h-11">
          <TabsTrigger value="active-play" className="gap-2 data-[state=active]:bg-primary/10 data-[state=active]:text-primary">
            <PlayCircle className="w-4 h-4" />
            Active Play
          </TabsTrigger>
          <TabsTrigger value="library" className="gap-2 data-[state=active]:bg-primary/10 data-[state=active]:text-primary">
        ...
        {/* ─── Active Play Tab ─────────────────────────────────────────────── */}
        <TabsContent value="active-play" className="mt-6 space-y-8">
