...
export default function ConfigPrompts() {
  const [activeTab, setActiveTab] = useState<"pass1" | "pass2" | "referee">("pass1");
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div>
        ...
        <p className="text-lg text-muted-foreground max-w-3xl">
          Manage and refine the system prompts used by the ensemble models at each stage of the OCR pipeline.
        </p>
      </div>
